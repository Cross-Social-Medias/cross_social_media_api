defmodule CrossSocialMediasApi.SocialMediaMappingTest do
  ...
  @valid_attrs %{mapping_name: "Anthony Lastella", twitter_username: "AnthonyLastella", instagram_username: "anthonylastella"}
  @invalid_attrs %{}
  ...
  test "mapping_name, twitter_username are required" do
