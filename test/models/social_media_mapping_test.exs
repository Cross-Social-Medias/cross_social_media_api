defmodule CrossSocialMediasApi.SocialMediaMappingTest do
  ...
  @valid_attrs %{mapping_name: "Anthony Lastella", twitter_username: "AnthonyLastella", instagram_username: "anthonylastella", created_by: 2}
  @invalid_attrs %{}
  ...
  test "mapping_name, twitter_username, created_by are required" do
    ...
    changeset_3 = SocialMediaMapping.changeset(%SocialMediaMapping{}, Map.delete(@valid_attrs, :created_by))
